...
export const getAll = async (req, res) => {
  try {
    ...
    const { all, category_id } = req.query;  // Obtener category_id de la consulta
    const includeInactive = all === '1'; // Controlar si se incluyen productos inactivos

    // Pasar category_id al servicio para que filtre los productos si está presente
