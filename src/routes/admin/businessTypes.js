...
router.get('/', async (req, res, next) => {
  try {
    ...
    console.error('❌ Error en GET /business-types:', error);
    next(error);
  }
});
...
router.get('/:id', async (req, res, next) => {
  try {
    ...
    console.error('❌ Error en GET /business-types/:id:', error);
    next(error);
  }
});
...
router.post('/', async (req, res, next) => {
  try {
    ...
    console.error('❌ Error en POST /business-types:', error);
    next(error);
  }
});
...
router.put('/:id', async (req, res, next) => {
  try {
    ...
    console.error('❌ Error en PUT /business-types/:id:', error);
    next(error);
  }
});
...
router.delete('/:id', async (req, res, next) => {
  try {
    ...
    console.error('❌ Error en DELETE /business-types/:id:', error);
    next(error);
  }
});
